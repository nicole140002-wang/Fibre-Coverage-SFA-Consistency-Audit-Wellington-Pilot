...
with Chorus-related Specified Fibre Area (SFA) parcels in Wellington City.

The project demonstrates how QGIS and PostgreSQL/PostGIS can be used to
validate geospatial datasets, calculate spatial overlap, identify potential
inconsistencies, and translate technical results into operational review
priorities.

![Final audit map](outputs/fibre_sfa_consistency_audit_wellington.png)
